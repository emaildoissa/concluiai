      ...
      <div className="ops-telemetry-bar">
        ...
        <div className="ops-actions-mobile">
          ...
          <div style={{ position: 'relative' }}>
            ...
            {actionsMenuOpen && (
              <>
                <div className="ops-popover-backdrop" onClick={() => setActionsMenuOpen(false)} />
                <div className="ops-popover-dropdown">
                  <div className="ops-popover-header">
                    <span>Ações Operacionais</span>
                    <button
                      type="button"
                      className="ops-popover-close"
                  ...
                  <div className="ops-popover-body">
                    <button
                      type="button"
                      className="ops-popover-item"
                      onClick={() => {
                      ...
                      disabled={busy !== null}
                    >
                      <div className="ops-popover-item-icon" style={{ background: 'rgba(56, 189, 248, 0.18)', color: '#38bdf8', borderColor: 'rgba(56, 189, 248, 0.35)' }}>
                      ...
                      <div className="ops-popover-item-content">
                        <strong>Gerar Rotinas do Dia</strong>
                        <span>Criar checklists operacionais da rede</span>
                      </div>
                    </button>
                    ...
                    <button
                      ...
                      disabled={busy !== null}
                    >
                      <div className="ops-popover-item-icon" style={{ background: 'rgba(244, 63, 94, 0.18)', color: '#f43f5e', borderColor: 'rgba(244, 63, 94, 0.35)' }}>
                        <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
                          <path d="M18 8A6 6 0 0 0 6 8c0 7-3 9-3 9h18s-3-2-3-9" />
                          <path d="M13.73 21a2 2 0 0 1-3.46 0" />
                        </svg>
                      ...
                      <div className="ops-popover-item-content">
                        ...
                        <span>Disparar alertas para tarefas vencidas</span>
                      </div>
                    </button>
                    ...
                    <button
                      ...
                      disabled={busy !== null}
                    >
                      <div className="ops-popover-item-icon" style={{ background: 'rgba(99, 102, 241, 0.18)', color: '#818cf8', borderColor: 'rgba(99, 102, 241, 0.35)' }}>
                        <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
                          <path d="M12 22s8-4 8-10V5l-8-3-8 3v7c0 6 8 10 8 10z" />
                          <path d="M9 12l2 2 4-4" />
                        </svg>
                      ...
                      <div className="ops-popover-item-content">
                        ...
                        <span>Recalcular pontualidade e qualidade</span>
                      </div>
                    </button>
                  </div>
                </div>
